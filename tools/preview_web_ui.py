...
def stub_config() -> dict:
    ...
    return {
        ...
        "radarAlertReturn": True,
        "radarAlertKeepRainKm": 100,
        "lightningSwitchToRadar": True,
        "lightningHoldMinutes": 10,
        "lightningCooldownMinutes": 30,
        "lightningQuietAtNight": False,
        "rainAlertCooldownMinutes": 30,
        "rainAlertRefreshMinutes": 5,
        "rainAlertQuietAtNight": False,
        # Výstrahy ČHMÚ a noční obloha: zapnuté, aby byly v náhledu vidět celé.
        "warningsEnabled": True,
        "warningsUrl": "https://hodiny:heslo@tvuj-server.example.net/warnings.json",
        "warningsMinimumLevel": 2,
        "warningsSwitchLevel": 3,
        "warningsHoldMinutes": 10,
        "warningsRefreshMinutes": 10,
        "warningsQuietAtNight": False,
        "warningsMessage": "",
        "warningsArea": "Říčany",
        "warningsCount": 1,
        "nightSkyEnabled": True,
        "nightSkyAuroraAlert": True,
        "nightSkyAuroraKp": 6,
        "nightSkyHoldMinutes": 10,
        "nightSkyCooldownMinutes": 120,
        # Upozorneni na telefon: zapnuta, at je v nahledu videt cela sekce.
        "pushAlertsEnabled": True,
        "pushAlertsUrl": "https://hodiny:heslo@tvuj-server.example.net/alerts",
        "pushAlertsRain": True,
        "pushAlertsRainLeadMinutes": 20,
        "pushAlertsRainMinimumDbz": 28,
        "pushAlertsRainRadiusKm": 5,
        "pushAlertsMilitary": True,
        "pushAlertsRare": True,
        "pushAlertsWatchRadiusKm": 30,
        "pushAlertsLow": True,
        "pushAlertsLowRadiusM": 1500,
        "pushAlertsLowHeightM": 500,
        "pushAlertsQuietFromHour": 22,
        "pushAlertsQuietToHour": 7,
        "pushAlertsMessage": "Server nastavení přijal",
